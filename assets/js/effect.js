/*
if (window.location.hostname != atob("bm9ub3BsYXl0di5naXRodWIuaW8=")){
    window.location = atob("aHR0cHM6Ly9ub25vcGxheXR2LmdpdGh1Yi5pbw==");
}
*/
function sleep(ms) {
...
elmcontainertester = document.getElementById('content-tester');
elmsbuttontester = document.getElementsByClassName('buttont');
elmsoptionstester = document.getElementsByClassName('options-tester');



/*
function tester(){
    if(elmcontainertester.style.display == 'block'){
        elmcontainertester.style.display
    }else{
...
for (var i = 0; i < elmsbuttontester.length; i++) {
    elmsbuttontester[i].addEventListener('click', function(event) {
        //console.log('resize');
        elmcontainertester.style.display = 'block';
    });
}

for (var i = 0; i < elmsoptionstester.length; i++) {
    elmsoptionstester[i].addEventListener('click', function(event) {
        //console.log('resize');
        elmcontainertester.style.display = 'none';
    });
}
